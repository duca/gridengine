...
# symbols which are imported by "from learn.controllers import *"
__all__ = ['Root']
...
# from learn import json


# log = logging.getLogger("learn.controllers")


class Root(controllers.RootController):
    """The root controller of the application."""

    @expose(template="learn.templates.welcome")
    ...
    @expose(template="learn.templates.login")
