...
# symbols which are imported by "from learn.model import *"
...
from sqlalchemy import String, Unicode, Integer, DateTime, Blob
...
# )
grid_queue = Table('fila', metadata,
      Column('id', Integer, primary_key=true, index=True),
      Column('nome', String(10), nullable=False),
      Column('dados', Blob, nullable=False),
      Column('node', String(5), nullable=False)
)
grid_nodes = 
