...
import os
execfile(os.path.join("learn", "release.py"))

packages=find_packages()
package_data = find_package_data(where='learn',
    package='learn')
...
setup(
    ...
    entry_points = {
        'console_scripts': [
            'start-learn = learn.command:start',
            # See the learn.command.bootstrap function for details
